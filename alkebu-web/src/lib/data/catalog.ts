...
export const fashionCategories: CatalogItem[] = [
...
export const fashionCollections: CatalogItem[] = [
  { slug: 'black-pride-collection', name: 'Black Pride Collection', type: 'fashion' },
  { slug: 'african-heritage', name: 'African Heritage', type: 'fashion' },
  { slug: 'activist-wear', name: 'Activist Wear', type: 'fashion' },
  { slug: 'handmade-jewelry', name: 'Handmade Jewelry', type: 'fashion' },
  { slug: 'crystal-collection', name: 'Crystal Collection', type: 'fashion' },
  { slug: 'cultural-fashion', name: 'Cultural Fashion', type: 'fashion' },
  { slug: 'chakra-jewelry', name: 'Chakra Jewelry', type: 'fashion' },
  { slug: 'statement-pieces', name: 'Statement Pieces', type: 'fashion' },
  { slug: 'new-arrivals', name: 'New Arrivals', type: 'fashion' },
  { slug: 'bestsellers', name: 'Bestsellers', type: 'fashion' },
  { slug: 'gift-guide', name: 'Gift Guide', type: 'fashion' },
  { slug: 'staff-picks', name: 'Staff Picks', type: 'fashion' },
  { slug: 'sale-items', name: 'Sale Items', type: 'fashion' },
  { slug: 'one-of-a-kind', name: 'One of a Kind', type: 'fashion' },
  { slug: 'healing-stones', name: 'Healing Stones', type: 'fashion' },
  { slug: 'protection-jewelry', name: 'Protection Jewelry', type: 'fashion' }
];

export const wellnessCategories: CatalogItem[] = [
...
export const oilCategories: CatalogItem[] = [
...
export const wellnessCollections: CatalogItem[] = [
...
export const oilCollections: CatalogItem[] = [
...
export const bookGenres: CatalogItem[] = [
...
export const bookCollections: CatalogItem[] = [
...
export const homeGoodsCategories: CatalogItem[] = [
