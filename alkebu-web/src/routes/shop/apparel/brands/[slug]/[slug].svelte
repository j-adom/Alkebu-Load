<script lang="ts">
    ...
    let { brand, products, pagination, currentSort, seo } = $derived(data);
...
<section class="page-header">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1>Apparel Brand: {brand?.name || 'Brand'}</h1>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/shop/apparel/brands">Brands</a></li>
            ...
            <div class="row">
                <div class="col-12 text-center py-5">
                    <div class="no-products">
                        ...
                        <p class="text-muted">No apparel items found from this brand.</p>
