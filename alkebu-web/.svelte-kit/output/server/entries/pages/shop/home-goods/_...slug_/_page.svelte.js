...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!----> <section class="page-header"${attr_style(`background-image: url(${stringify(product.images?.[0]?.url || "/assets/images/resources/page-header-bg.jpg")});`)}><div class="container"><h2>${escape_html(product.title)}</h2> <ul class="flex items-center gap-2 text-sm text-white/80"><li><a href="/">Home</a></li> <li><a href="/shop">Shop</a></li> <li><a href="/shop/home-goods">Art &amp; Imports</a></li> <li><span>${escape_html(product.title)}</span></li></ul></div></section> <section class="product-detail py-12"><div class="container mx-auto px-6 lg:px-12"><div class="grid grid-cols-1 lg:grid-cols-2 gap-12"><div><div class="sticky top-24">`);
    ...
    if (product.artisan || product.artist) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<p class="text-sm text-primary mb-2 uppercase tracking-wide font-semibold">By ${escape_html(product.artisan?.name || product.artist)}</p>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    ...
    if (product.description) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="mb-8"><h2 class="text-2xl font-bold mb-4 text-foreground">About This Item</h2> <div class="prose max-w-none"><p class="text-gray-700 leading-relaxed">${escape_html(product.description)}</p></div></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    ...
    if (product.origin || product.countryOfOrigin) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="flex justify-between py-2 border-b border-gray-200"><dt class="font-medium text-gray-700">Origin:</dt> <dd class="text-gray-600">${escape_html(product.origin || product.countryOfOrigin)}</dd></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
    if (product.dimensions) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="flex justify-between py-2 border-b border-gray-200"><dt class="font-medium text-gray-700">Dimensions:</dt> <dd class="text-gray-600">${escape_html(product.dimensions)}</dd></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
    if (product.materials) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="flex justify-between py-2 border-b border-gray-200"><dt class="font-medium text-gray-700">Materials:</dt> <dd class="text-gray-600">${escape_html(product.materials)}</dd></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
    ...
    if (product.culturalSignificance || product.story) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="bg-muted rounded-lg p-6 mb-6"><h3 class="text-lg font-bold mb-3 text-foreground"><i class="far fa-star mr-2"></i> Cultural Significance</h3> <p class="text-gray-700">${escape_html(product.culturalSignificance || product.story)}</p></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
    if (product.careInstructions) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="bg-blue-50 border border-blue-200 rounded-lg p-6"><h3 class="text-lg font-bold mb-3 text-blue-800"><i class="far fa-hand-sparkles mr-2"></i> Care Instructions</h3> <p class="text-blue-700 text-sm">${escape_html(product.careInstructions)}</p></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
