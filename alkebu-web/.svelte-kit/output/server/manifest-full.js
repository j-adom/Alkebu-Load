	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/cart/add/_server.ts.js'))
			},
			{
				id: "/api/cart/clear",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/cart/clear/_server.ts.js'))
			},
			{
				id: "/api/cart/remove",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/cart/remove/_server.ts.js'))
			},
			{
				id: "/api/cart/summary",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/cart/summary/_server.ts.js'))
			},
			{
				id: "/api/cart/update",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/cart/update/_server.ts.js'))
			},
			{
				id: "/api/checkout",
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/checkout/preview/_server.ts.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/media/file/_...path_/_server.ts.js'))
			},
			{
				id: "/blog",
				pattern: /^\/blog\/?$/,
